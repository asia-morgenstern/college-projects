""" transcendental_eq - genetic algorithm that solves the transcendental equation cosx = x
...
class Individual(object):
    ...
    def gen_chromosome():
        ...
        n = random.random()*MAX_VAL             # random float [0, MAX_VAL)
...
def print_individual(indiv, gen):
    ...
    print(f"Generation {gen}  String:  {curr_str}  Val:  {curr_val}  Fitness:  {curr_fit}")
